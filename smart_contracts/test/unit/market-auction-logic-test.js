...
!developmentChains.includes(network.name)
  ...
  : describe("AART market Auction Logic Unit Tests", () => {
      ...
      async function deployAndStartAuction(token) {
        ...
        AuctionParam.startTime = now + 60;        // start 1 minute from now
        AuctionParam.endTime   = now + 120; 
...
const now = block.timestamp;
          ...
          AuctionParam.startTime = now + 120;        // start 1 minute from now
        AuctionParam.endTime   = now + 60; 
